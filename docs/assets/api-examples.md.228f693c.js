import {
  ...
  N as c,
  a as e
} from './chunks/framework.0e99e60c.js'
const d = c(
...
<span class="line"><span style="color:#A6ACCD;">&lt;pre&gt;{{ frontmatter }}&lt;/pre&gt;</span></span></code></pre></div><h2 id="results" tabindex="-1">Results <a class="header-anchor" href="#results" aria-label="Permalink to &quot;Results&quot;">​</a></h2><h3 id="theme-data" tabindex="-1">Theme Data <a class="header-anchor" href="#theme-data" aria-label="Permalink to &quot;Theme Data&quot;">​</a></h3>`,
    6
  ),
  m = a(
    'h3',
  ...
  _ = a(
    ...
    null,
    [
      e('Check out the documentation for the '),
      a(
        'a',
        {
  ...
  g = { name: 'api-examples.md' },
  y = Object.assign(g, {
    setup(f) {
      const { site: D, theme: n, page: l, frontmatter: r } = p()
      return (A, C) => (
        o(),
        i('div', null, [
          d,
